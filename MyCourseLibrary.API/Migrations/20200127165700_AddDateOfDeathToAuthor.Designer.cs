...
namespace CourseLibrary.Migrations
{
    ...
    [Migration("20200127165700_AddDateOfDeathToAuthor")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyCourseLibrary.API.API.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MyCourseLibrary.API.API.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyCourseLibrary.API.API.Entities.Course", b =>
                {
                    b.HasOne("MyCourseLibrary.API.API.Entities.Author", "Author")
                        .WithMany("Courses")
